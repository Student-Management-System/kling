...
export class CourseParticipantsService {
     ...
     */
    public addUser(courseId: string, userId: string, passwordDto: PasswordDto, observe?: 'body', reportProgress?: boolean, options?: {httpHeaderAccept?: undefined}): Observable<any>;
    public addUser(courseId: string, userId: string, passwordDto: PasswordDto, observe?: 'response', reportProgress?: boolean, options?: {httpHeaderAccept?: undefined}): Observable<HttpResponse<any>>;
    public addUser(courseId: string, userId: string, passwordDto: PasswordDto, observe?: 'events', reportProgress?: boolean, options?: {httpHeaderAccept?: undefined}): Observable<HttpEvent<any>>;
    public addUser(courseId: string, userId: string, passwordDto: PasswordDto, observe: any = 'body', reportProgress: boolean = false, options?: {httpHeaderAccept?: undefined}): Observable<any> {
     ...
     * @param reportProgress flag to report request and response progress.
     */
    public updateUserRole(courseId: string, userId: string, changeCourseRoleDto: ChangeCourseRoleDto, observe?: 'body', reportProgress?: boolean, options?: {httpHeaderAccept?: undefined}): Observable<any>;
    public updateUserRole(courseId: string, userId: string, changeCourseRoleDto: ChangeCourseRoleDto, observe?: 'response', reportProgress?: boolean, options?: {httpHeaderAccept?: undefined}): Observable<HttpResponse<any>>;
    public updateUserRole(courseId: string, userId: string, changeCourseRoleDto: ChangeCourseRoleDto, observe?: 'events', reportProgress?: boolean, options?: {httpHeaderAccept?: undefined}): Observable<HttpEvent<any>>;
    public updateUserRole(courseId: string, userId: string, changeCourseRoleDto: ChangeCourseRoleDto, observe: any = 'body', reportProgress: boolean = false, options?: {httpHeaderAccept?: undefined}): Observable<any> {
        if (courseId === null || courseId === undefined) {
